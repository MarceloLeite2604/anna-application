...
public class CommanderThread extends Thread implements CommandExecutorInterface {
    ...
    private static final String LOG_TAG = CommanderThread.class.getSimpleName();
    ...
    public void executeCommand(CommandTask commandTask) {
        Log.d(LOG_TAG, "checkCommandToExecute, 70: Executing command \"" + commandTask.getCommandType() + "\".");
        ...
        switch (commandTask.getCommandType()) {
            ...
            case STOP_AUDIO_RECORD:
                ...
                break;
            case DISCONNECT:
                Log.w(LOG_TAG, "executeCommand, 79: \"" + commandTask.getCommandType() + "\"Not implemented yet.");
            ...
            case FINISH_EXECUTION:
                ...
                break;
            default:
                Log.e(LOG_TAG, "executeInterfaceCommand, 37: Unknown commandTask \"" + commandTask.getCommandType() + "\".");
                break;
        }
        ...
        Log.d(LOG_TAG, "executeCommand, 105: Sending the result of command " + commandTask.getCommandType());
