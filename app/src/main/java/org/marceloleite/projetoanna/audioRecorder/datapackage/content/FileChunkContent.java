...
public class FileChunkContent extends Content {
    ...
    public FileChunkContent(byte[] bytes) {
        ...
        int chunkSize = ByteBuffer.wrap(byteArraySlice).getInt();
    ...
    public byte[] convertToBytes() {
        ...
        byte[] chunkSizeBytes = ByteBuffer.allocate(CHUNK_SIZE_BYTE_ARRAY_SIZE).putInt(this.fileChunk.length).array();
