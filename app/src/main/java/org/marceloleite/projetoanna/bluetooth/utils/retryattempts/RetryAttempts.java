package org.marceloleite.projetoanna.bluetooth.utils.retryattempts;
...
public class RetryAttempts {
    ...
    private static final int MINIMUM_WAIT_TIME = 100;

    private static final int WAIT_TIME_STEP = 700;
